...
namespace Memory {
    ...
    // Dynamic signature scanner (pattern scanning) to locate code blocks
    inline uintptr_t FindSignature(const std::string& signature) {
        ...
        // Get header structure to scan within __TEXT segment
        ...
        size_t scanSize = 100 * 1024 * 1024; // Limit scans to 100MB to avoid scanning overhead
